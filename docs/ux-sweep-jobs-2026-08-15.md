...
| 11  | **No save state on the resume editor.** Edits _do_ autosave (verified across a full navigation away and back), but there is no Save button, no dirty/saved indicator, and no "done / applied" terminal action.                                                                                                               |
